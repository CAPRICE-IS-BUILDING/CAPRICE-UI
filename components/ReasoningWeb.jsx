...
const ROSTER = [
  ['executive', 'Executive Command', 'consultant', 250, 205, true, 18, 9],
  ['hse', 'HSE', 'consultant', 330, 112, true, -20, 7],
  ['business', 'Business & Commerce', 'doer', 438, 145, true, -20, 7],
  ['productivity', 'Productivity', 'consultant', 510, 225, true, -24, 7],
  ['finance', 'Finance', 'consultant', 480, 326, true, -20, 7],
  ['health', 'Health', 'tool', 382, 382, false, -18, 6],
  ['security', 'Security', 'doer', 275, 370, true, 20, 7],
  ['intelligence', 'Market Intelligence', 'consultant', 180, 315, true, 22, 7],
  ['investment', 'Investment', 'doer', 145, 220, false, 24, 7],
  ['documents', 'Documents', 'tool', 205, 130, true, 22, 6],
  ['voice', 'Voice', 'tool', 570, 310, true, -24, 6],
  ['system', 'System Operations', 'tool', 565, 135, true, -24, 6],
]
  ...
  return (
    <>
      ...
      <svg ref={svgRef} width="100%" height="100%" viewBox={viewBox || "0 0 680 480"}
           ...
           role="img" aria-label="CAPRICE department reasoning web" />
    </>
  )
}
